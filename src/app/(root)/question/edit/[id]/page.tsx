...
const Page = async ({ params }: ParamsProps) => {
  ...
  // Remove the hardcoded loading state that prevents the page from working
  ...
  return (
    <div className="w-full h-[calc(100vh-120px)] mt-18 overflow-y-auto scrollbar-hidden max-w-5xl mx-auto px-4 pt-6 pb-10 text-black dark:text-white">
      <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold font-mono text-black dark:text-white">
        Edit Question
      </h1>
