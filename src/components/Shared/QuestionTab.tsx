  ...
  <div className="mt-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 text-sm 
    ...
    <div className="flex flex-wrap items-center gap-4 text-xs sm:text-sm">
      ...
      {typeof upvotes === "number" && (
        <span title="Upvote" className="flex items-center gap-1 dark:text-white text-red-600">
      ...
      {typeof answers === "number" && (
        <span title="Answer" className="flex items-center gap-1 dark:text-zinc-100 text-zinc-700">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
            strokeWidth={1.5} stroke="currentColor" className="size-4.5">
      ...
      {/* Views */}
      {typeof views === "number" && (
        <span title="Views" className="flex items-center gap-1 dark:text-zinc-100 text-zinc-700">
      ...
      {/* Date */}
      {createdAt && (
        <span title="Created At" className="text-xs spacing-tighter font-semibold select-none 
