...
const Stats = ({ totalQuestions, totalAnswers, badges, reputation }: Props) => {
  return (
    <div className="mt-10">
      <h4 className="text-regular text-dark200_light900">Stats - <span className="text-lg font-semibold">{reputation}</span></h4>
      ...
      <div className="mt-5 grid grid-cols-1 gap-5 xs:grid-cols-2 md:grid-cols-4">
        <div className="light-border background-light900_dark300 flex flex-wrap px-2 items-center justify-evenly gap-4 rounded-md border p-6 shadow-light-300 dark:shadow-dark-200">
          <div>
            ...
            <p className="font-mono text-dark400_light700">Questions</p>
          </div>
          <div>
            <p className="font-semibold text-lg text-dark200_light900">
              {formatAndDivideNumber(totalAnswers)}
            </p>
            <p className="font-mono text-dark400_light700">Answers</p>
          </div>
        </div>
