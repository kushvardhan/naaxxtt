...
const RenderTag = ({ _id, name, totalQuestions, showCount }: Props) => {
  return (
    <Link
      href={`/tags/${_id}`}
      className="group flex items-center justify-between gap-3 rounded-lg border border-zinc-500 dark:border-zinc-300 bg-light-800 dark:bg-dark-300 px-3 py-2 transition-all duration-200 hover:bg-light-700 hover:dark:bg-dark-100"
    >
