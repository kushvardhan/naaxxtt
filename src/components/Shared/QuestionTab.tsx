...
function QuestionCard({
  ...
  return (
    <div
      className="w-full rounded-xl cursor-pointer border p-4 shadow-md transition-all duration-200 hover:shadow-lg
  bg-white border-zinc-300 shadow-zinc-400
  dark:bg-zinc-950 dark:border-zinc-700 dark:shadow-zinc-800"
    >
      {/* Title */}
      {title && (
