  ...
  return (
    <div className="relative inline-block text-left font-mono" ref={dropdownRef}>
      <button
        ...
        className={`p-2 rounded-xl flex items-center justify-center shadow-md border transition-colors
      ...
      {open && (
        <div
          className={`absolute right-0 mt-2 w-44 rounded-xl shadow-lg z-50
            ${mode === "dark"
